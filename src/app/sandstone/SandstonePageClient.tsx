...
const sandstones = getGranitesByCollection("Sandstone");

const features = [
  { icon: Package, label: "Wide Range", desc: "8 premium varieties" },
...
export function SandstonePageClient() {
  return (
    <>
      {/* Hero */}
      <section className="relative bg-surface overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/images/sandstone/Yellow Sandstone.jpg"
            alt="Sandstone"
            fill
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 py-20 md:py-28">
          ...
          >
            Sandstone brings the warmth of nature into every space. With its
            earthy tones and textured finish, it&apos;s perfect for flooring, wall
            cladding, paving, and outdoor landscapes.
          </motion.p>
        </div>
      </section>
      ...
      <section className="section-padding bg-surface">
        <div className="max-w-[1400px] mx-auto px-6">
          <SectionHeading
            ...
            title="Premium Sandstone Varieties"
          />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {sandstones.map((stone, i) => (
              <motion.div
                key={stone.id}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
