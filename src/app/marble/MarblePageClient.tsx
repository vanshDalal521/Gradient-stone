...
const marbles = getGranitesByCollection("Marble");

const features = [
  { icon: Package, label: "Premium Selection", desc: "5 luxury marble varieties" },
...
export function MarblePageClient() {
  return (
    <>
      {/* Hero */}
      <section className="relative bg-surface overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/images/granites/Moon white .png"
            alt="Marble"
            fill
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 py-20 md:py-28">
          ...
          >
            Marble embodies luxury and sophistication. Its natural veining and
            luminous surface make it the ultimate choice for premium interiors,
            grand entrances, and statement surfaces.
          </motion.p>
        </div>
      </section>
      ...
      <section className="section-padding bg-surface">
        <div className="max-w-[1400px] mx-auto px-6">
          <SectionHeading
            ...
            title="Premium Marble Varieties"
          />
