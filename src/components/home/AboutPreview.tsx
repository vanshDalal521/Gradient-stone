    ...
    <section className="relative py-28 bg-white">
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            With 7+ manufacturing units across 5 locations and exports to 40+ countries, we&apos;ve proven that quality and consistency can make Indian stone compete with the best in the world.
          </motion.p>
